...
import OCAttribute.Attr_Button_Idea;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Idea extends OCButton {

	public Attr_Button_Idea attr;

	public OCButton_Idea(int height, int width) {
		super("", height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Idea();
