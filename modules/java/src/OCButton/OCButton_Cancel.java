...
import OCAttribute.Attr_Button_Cancel;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Cancel extends OCButton {

	public Attr_Button_Cancel attr;

	public OCButton_Cancel(int height, int width) {
		super("", height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Cancel();
