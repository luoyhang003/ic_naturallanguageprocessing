...
import OCAttribute.Attr_Button_DOWN;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_DOWN extends OCButton {

	public Attr_Button_DOWN attr;

	public OCButton_DOWN(int height, int width) {
		super("", height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_DOWN();
