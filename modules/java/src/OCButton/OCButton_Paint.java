...
import OCAttribute.Attr_Button_Paint;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Paint extends OCButton {

	public Attr_Button_Paint attr;

	public OCButton_Paint(int height, int width) {
		super("",height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Paint();
		...
		OCFileWorker.copyFile(srcFile2, destDir2,"paint.png");
		Path = OCDirector.RootPath + "/component/No" + OCStaticValue.OCid
				+ "OCButton_Paint.html";

		Html = "No" + OCStaticValue.OCid + "OCButton_Paint.html";
		OCStaticValue.OCid++;
		/*
		 * 生成json
		 */
