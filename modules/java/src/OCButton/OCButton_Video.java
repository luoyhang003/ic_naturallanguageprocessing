...
import OCAttribute.Attr_Button_Video;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Video extends OCButton {

	public Attr_Button_Video attr;

	public OCButton_Video(int height, int width) {
		super("", height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Video();
