...
import OCAttribute.Attr_Button_OK;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_OK extends OCButton {

	public Attr_Button_OK attr;

	public OCButton_OK(int height, int width) {
		super("",height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_OK();
		...
		OCFileWorker.copyFile(srcFile2, destDir2,"correct.png");
		Path = OCDirector.RootPath + "/component/No" + OCStaticValue.OCid
				+ "OCButton_OK.html";

		Html = "No" + OCStaticValue.OCid + "OCButton_OK.html";
		OCStaticValue.OCid++;
		/*
		 * 生成json
		 */
