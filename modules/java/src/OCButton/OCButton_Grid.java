...
import OCAttribute.Attr_Button_Grid;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Grid extends OCButton {

	public Attr_Button_Grid attr;

	public OCButton_Grid(int height, int width) {
		super("", height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Grid();
