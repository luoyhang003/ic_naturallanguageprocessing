...
import OCAttribute.Attr_Button_UP;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_UP extends OCButton {

	public Attr_Button_UP attr;

	public OCButton_UP(int height, int width) {
		super("",height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_UP();
		...
		OCFileWorker.copyFile(srcFile2, destDir2,"up.png");
		Path = OCDirector.RootPath + "/component/No" + OCStaticValue.OCid
				+ "OCButton_UP.html";

		Html = "No" + OCStaticValue.OCid + "OCButton_UP.html";
		OCStaticValue.OCid++;
		/*
		 * 生成json
		 */
