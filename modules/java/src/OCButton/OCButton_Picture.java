...
import OCAttribute.Attr_Button_Picture;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Picture extends OCButton {

	public Attr_Button_Picture attr;

	public OCButton_Picture(int height, int width) {
		super("",height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Picture();
