...
import OCAttribute.Attr_Button_Music;
 ...
 *         OC模板——3D弹性按钮
 */
public class OCButton_Music extends OCButton {

	public Attr_Button_Music attr;

	public OCButton_Music(int height, int width) {
		super("",height, width);

		this.width = width;
		this.height = height;

		attr = new Attr_Button_Music();
		...
		OCFileWorker.copyFile(srcFile2, destDir2,"music.png");
		Path = OCDirector.RootPath + "/component/No" + OCStaticValue.OCid
				+ "OCButton_Music.html";

		Html = "No" + OCStaticValue.OCid + "OCButton_Music.html";
		OCStaticValue.OCid++;
		/*
		 * 生成json
		 */
